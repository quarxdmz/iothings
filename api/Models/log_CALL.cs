...
public partial class log_CALL
{

    public long id { get; set; }

    public Nullable<long> rel_ref_CALL_type_id { get; set; }

    public string term_phone { get; set; }
    ...
    public virtual ref_CALL_type ref_CALL_type { get; set; }
