...
namespace api.Controllers
{
    public class SpecialtyController : ApiController
    {
        ...
        [HttpGet]
        [Route("specialty/id")]
        public IHttpActionResult Getspecialty_id(string id)
        {
            string msg = "";
            if (true)//progAuth.authorize()
            {

                List<doc_specialty2> spec = specialty;
        ...
        [HttpGet]
        [Route("specialty")]
        public IHttpActionResult Getspecialty()
        {
            string msg = "";
            if (true)//progAuth.authorize()
            {
        ...
        private List<doc_specialty2> specialty {
            get {
                List<doc_specialty2> spec = new List<doc_specialty2>();
